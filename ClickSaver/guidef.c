...
PU_ACTION_OBJDEF, CS_ITEMWATCH_TAB, ( PUU32 )"VerGroup", 0,
    PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_ITEMWATCH_LISTVIEW, ( PUU32 )"ListView",
        ...
        // Buttons
        PUM_ADDCHILD, PU_HORGROUP,
            PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_ITEM_ADD_BTN, ( PUU32 )"Text", PUA_TEXT_STRING, ( PUU32 )"Add",
                PUA_CONTROL_FRAME, PUFRAME_BUTTON,
                PUA_CONTROL_ISBUTTON, TRUE, 0,
                PUM_ADDNOTIFICATION,
                    PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
                    PUNOTIFY_ACTION_APPMSG, CSAM_ITEM_ADD_OK,
                0,
            PUM_ADDCHILD, PU_ACTION_OBJDEF, 0, ( PUU32 )"Text", PUA_TEXT_STRING, ( PUU32 )"Mass Add",
                PUA_CONTROL_FRAME, PUFRAME_BUTTON,
                PUA_CONTROL_ISBUTTON, TRUE, 0,
                PUM_ADDNOTIFICATION,
                    PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
                    PUNOTIFY_ACTION_APPMSG, CSAM_MASS_ADD_ITEMS,
                0,
            PUM_ADDCHILD, PU_ACTION_OBJDEF, 0, ( PUU32 )"Text", PUA_TEXT_STRING, ( PUU32 )"Remove",
                ...
                0,
            PUM_ADDCHILD, PU_ACTION_OBJDEF, 0, ( PUU32 )"Text", PUA_TEXT_STRING, ( PUU32 )"Remove All",
                PUA_CONTROL_FRAME, PUFRAME_BUTTON,
                PUA_CONTROL_ISBUTTON, TRUE, 0,
                PUM_ADDNOTIFICATION,
                    PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
                    PUNOTIFY_ACTION_APPMSG, CSAM_REMOVE_ALL_ITEMS,
                0,
            PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_ITEM_EDIT_BTN, ( PUU32 )"Text", PUA_TEXT_STRING, ( PUU32 )"Edit",
                PUA_CONTROL_FRAME, PUFRAME_BUTTON,
                PUA_CONTROL_ISBUTTON, TRUE, 0,
                PUM_ADDNOTIFICATION,
                    PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
                    PUNOTIFY_ACTION_APPMSG, CSAM_EDIT_ITEM,
                0,
            PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_DISABLE_BTN, ( PUU32 )"Text", PUA_TEXT_STRING, ( PUU32 )"Disable >>",
                PUA_CONTROL_FRAME, PUFRAME_BUTTON,
                PUA_CONTROL_ISBUTTON, TRUE, 0,
                PUM_ADDNOTIFICATION,
                    PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
                    PUNOTIFY_ACTION_APPMSG, CSAM_DISABLE_ITEM,
                0,
        PU_ENDGROUP,
		PUM_ADDCHILD, PU_HORGROUP,
		// After the "Mass Add" button, add:
			PUM_ADDCHILD, PU_ACTION_OBJDEF, 0, (PUU32)"Text", PUA_TEXT_STRING, (PUU32)"Import Items",
				PUA_CONTROL_FRAME, PUFRAME_BUTTON,
				PUA_CONTROL_ISBUTTON, TRUE, 0,
				PUM_ADDNOTIFICATION,
					PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
					PUNOTIFY_ACTION_APPMSG, CSAM_IMPORT_ITEMS,   // new single message
				0,
			PUM_ADDCHILD, PU_ACTION_OBJDEF, 0, (PUU32)"Text", PUA_TEXT_STRING, (PUU32)"Export Items",
				PUA_CONTROL_FRAME, PUFRAME_BUTTON,
				PUA_CONTROL_ISBUTTON, TRUE, 0,
				PUM_ADDNOTIFICATION,
					PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
					PUNOTIFY_ACTION_APPMSG, CSAM_EXPORT_ITEMS,
				0,
			PUM_ADDCHILD, PU_ACTION_OBJDEF, 0, (PUU32)"Text", PUA_TEXT_STRING, (PUU32)"Remove Duplicates",
				PUA_CONTROL_FRAME, PUFRAME_BUTTON,
				PUA_CONTROL_ISBUTTON, TRUE, 0,
				PUM_ADDNOTIFICATION,
					PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
					PUNOTIFY_ACTION_APPMSG, CSAM_REMOVE_DUPLICATE_ITEMS,
				0,
		PU_ENDGROUP,
        PUM_ADDCHILD, PU_LABEL( "Tip: include QL in name to target specific QL (e.g., QL10 Staff)" ),
        PUM_ADDCHILD, PU_TITLE( "Search Options" ),
        PUM_ADDCHILD, PU_HORGROUP,
        ...
        PU_ENDGROUP,
        PUM_ADDCHILD, PU_HORGROUP,
            PUM_ADDCHILD, PU_CHECKBOX( CS_STRICT_FINDITEM_CB, "Force FindItem (reward+find must match)" ),
        PU_ENDGROUP,
    PU_ENDGROUP,
// ****
...
// **** Location list tab ****
    PU_ACTION_OBJDEF, CS_LOCWATCH_TAB, ( PUU32 )"VerGroup", 0,
        PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_LOCWATCH_LISTVIEW, ( PUU32 )"ListView",
            ...
            PU_ENDGROUP,
			PUM_ADDCHILD, PU_HORGROUP,
            PUM_ADDCHILD, PU_ACTION_OBJDEF, 0, ( PUU32 )"Text", PUA_TEXT_STRING, ( PUU32 )"Import Locations",
                PUA_CONTROL_FRAME, PUFRAME_BUTTON,
                PUA_CONTROL_ISBUTTON, TRUE, 0,
                PUM_ADDNOTIFICATION,
                    PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
                    PUNOTIFY_ACTION_APPMSG, CSAM_IMPORT_LOCATIONS,
                0,
            PUM_ADDCHILD, PU_ACTION_OBJDEF, 0, ( PUU32 )"Text", PUA_TEXT_STRING, ( PUU32 )"Export Locations",
                PUA_CONTROL_FRAME, PUFRAME_BUTTON,
                PUA_CONTROL_ISBUTTON, TRUE, 0,
                PUM_ADDNOTIFICATION,
                    PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
                    PUNOTIFY_ACTION_APPMSG, CSAM_EXPORT_LOCATIONS,
                0,
			PU_ENDGROUP,
			PUM_ADDCHILD, PU_LABEL( "Tip: prefix an entry with # to disable it" ),
			PUM_ADDCHILD, PU_LABEL( "Tip: Add coordinates to a location (Xmin-Xmax, Ymin-Ymax)." ),
			PUM_ADDCHILD, PU_LABEL( "Example: \"Stret West Bank (1113.6-1313.6, 2563.0-2963.0)\"" ),
...
// **** Options tab ****
    PU_ACTION_OBJDEF, CS_OPTIONS_TAB, ( PUU32 )"VerGroup", 0,
		PUM_ADDCHILD, PU_TITLE( "ClickSaver (Skuly Edition) "CS_VERSION", for Project RK" ),
		PUM_ADDCHILD, PU_LABEL("Created by Ar1z for Project RK"),
		PUM_ADDCHILD, PU_LABEL("Modified by Skuly for Project RK"),
		PUM_ADDCHILD, PU_LABEL("https://users.math.uoc.gr/~ar1z/index.html"),
		PUM_ADDCHILD, PU_LABEL(" "),
		PUM_ADDCHILD, PU_TITLE("Contributors:"),
		PUM_ADDCHILD, PU_LABEL("pzychotic, (https://github.com/pzychotic/ClickSaver/)"),
                    ...
                    PU_HORGROUP,
                        PUM_ADDCHILD, PU_LEFT_VERGROUP,
                            ...
                            PUM_ADDCHILD, PU_CHECKBOX( CS_EXPAND_CB, "Auto Expand Team Missions" ),
								PUM_ADDCHILD, PU_HORGROUP,
								PUM_ADDCHILD, PU_LABEL( "Buying Agent Delay ms:" ),
								PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_BUYINGAGENTDELAY_ENTRY, ( PUU32 )"TextEntry",
									PUA_CONTROL_WEIGHT, 1,
									PUA_TEXTENTRY_NUMERIC, TRUE,
									PUA_TEXTENTRY_BUFFERSIZE, 5,
									PUA_TEXTENTRY_MAX, 15000,
									PUA_TEXTENTRY_VALUE, 5200,
									PUA_TEXTENTRY_MIN, 5200,
									PUA_CONTROL_MINWIDTH, 80,
									0, 0,
								PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_BUYINGAGENTDELAY_BTN, ( PUU32 )"Text",
									PUA_TEXT_STRING, ( PUU32 )"Set Delay",
									PUA_CONTROL_FRAME, PUFRAME_BUTTON,
									PUA_CONTROL_ISBUTTON, TRUE, 0,
									PUM_ADDNOTIFICATION,
										PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
										PUNOTIFY_ACTION_APPMSG, CSAM_UPDATE_DELAY,
									0,
								PU_ENDGROUP,
                        PU_ENDGROUP,
                    PUM_ADDCHILD, PU_SPACER,
...
// **** Exits tab (with left‑aligned folds inside a framed group) ****
PU_ACTION_OBJDEF, CS_EXITS_TAB, ( PUU32 )"VerGroup", 0,
    PUM_ADDCHILD, PU_LABEL("Accept missions near specific Whompah and Grid exits."),
    PUM_ADDCHILD, PU_LABEL("Expand the group you want to select from."),

    // Framed group containing all exit folds, with left alignment
    PUM_ADDCHILD, PU_FRAMED_VERGROUP( PUFRAME_GROUP, "Exits" ),
        PUM_ADDCHILD, PU_LEFT_VERGROUP,   // <<-- left‑align the contents

            // Whompahs - Neutral (6)
            PUM_ADDCHILD, PU_ACTION_OBJDEF, 0, ( PUU32 )"Fold",
                PUA_FOLD_LABEL, ( PUU32 )"Whompahs - Neut",
                PUA_FOLD_FOLDED, TRUE,
                PUA_FOLD_CONTENTS, PU_LEFT_VERGROUP,
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 0, "Newland City"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 1, "Newland Desert"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 2, "Hope"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 3, "Stret West Bank"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 4, "Borealis"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 5, "ICC"),
                PU_ENDGROUP,
            0, 0,

            // Whompahs - Omni (11)
            PUM_ADDCHILD, PU_ACTION_OBJDEF, 0, ( PUU32 )"Fold",
                PUA_FOLD_LABEL, ( PUU32 )"Whompahs - Omni",
                PUA_FOLD_FOLDED, TRUE,
                PUA_FOLD_CONTENTS, PU_LEFT_VERGROUP,
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 6, "Omni Trade"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 7, "Galway Castle"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 8, "Outpost 10-3"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 9, "2HO"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 10, "The Longest Road"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 11, "4Holes"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 12, "20K"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 13, "Broken Shores"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 14, "Rome"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 15, "Omni Ent"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 16, "Mutant Domain"),
                PU_ENDGROUP,
            0, 0,

            // Whompahs - Clan (8)
            PUM_ADDCHILD, PU_ACTION_OBJDEF, 0, ( PUU32 )"Fold",
                PUA_FOLD_LABEL, ( PUU32 )"Whompahs - Clan",
                PUA_FOLD_FOLDED, TRUE,
                PUA_FOLD_CONTENTS, PU_LEFT_VERGROUP,
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 17, "Tir"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 18, "Varmint Woods"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 19, "Wine"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 20, "Wailing Wastes"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 21, "Old Athen"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 22, "Bliss"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 23, "Broken Shores"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 24, "Avalon"),
                PU_ENDGROUP,
            0, 0,
			
			PUM_ADDCHILD, PU_LABEL(" "),
			
            // Grid Exits - Neutral (9)
            PUM_ADDCHILD, PU_ACTION_OBJDEF, 0, ( PUU32 )"Fold",
                PUA_FOLD_LABEL, ( PUU32 )"Grid - Neut",
                PUA_FOLD_FOLDED, TRUE,
                PUA_FOLD_CONTENTS, PU_LEFT_VERGROUP,
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 25, "Newland City"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 26, "Borealis"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 27, "Meetmedere"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 28, "Broken Shores"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 29, "Harry's"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 30, "Sentinels"),
                PU_ENDGROUP,
            0, 0,

            // Grid Exits - Omni (7)
            PUM_ADDCHILD, PU_ACTION_OBJDEF, 0, ( PUU32 )"Fold",
                PUA_FOLD_LABEL, ( PUU32 )"Grid - Omni",
                PUA_FOLD_FOLDED, TRUE,
                PUA_FOLD_CONTENTS, PU_LEFT_VERGROUP,
					PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 31, "Clondyke"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 32, "Galway"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 33, "Lush Hills"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 34, "Omni Ent"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 35, "Rome"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 36, "2HO"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 37, "4Holes"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 38, "Omni HQ"),
                PU_ENDGROUP,
            0, 0,
			
			// Grid Exits - Clan (4)
            PUM_ADDCHILD, PU_ACTION_OBJDEF, 0, ( PUU32 )"Fold",
                PUA_FOLD_LABEL, ( PUU32 )"Grid - Clan",
                PUA_FOLD_FOLDED, TRUE,
                PUA_FOLD_CONTENTS, PU_LEFT_VERGROUP,
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 39, "Tir"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 40, "Old Athen"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 41, "West Athen"),
                    PUM_ADDCHILD, PU_CHECKBOX(CS_EXIT_FIRST + 42, "Camelot"),
                PU_ENDGROUP,
            0, 0,

        PU_ENDGROUP,   // end of left vertical group
    PU_ENDGROUP,       // end of framed group

    // ----- Proximity and search options (unchanged) -----
    PUM_ADDCHILD, PU_TITLE( "Proximity Settings" ),
    PUM_ADDCHILD, PU_HORGROUP,
        PUM_ADDCHILD, PU_LABEL( "Accept mission if within " ),
        PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_EXITS_RADIUS_SLIDER, ( PUU32 )"TextEntry",
            PUA_CONTROL_WEIGHT, 1,
            PUA_TEXTENTRY_NUMERIC, TRUE,
            PUA_TEXTENTRY_MIN, 100,
            PUA_TEXTENTRY_MAX, 5000,
            PUA_TEXTENTRY_BUFFERSIZE, 4,
            PUA_TEXTENTRY_VALUE, 100,
            PUA_CONTROL_MINWIDTH, 50,
        0, 0,
        PUM_ADDCHILD, PU_LABEL( " meters" ),
        PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_EXITS_RADIUS_BTN, ( PUU32 )"Text",
            PUA_TEXT_STRING, ( PUU32 )"Set",
            PUA_CONTROL_FRAME, PUFRAME_BUTTON,
            PUA_CONTROL_ISBUTTON, TRUE, 0,
            PUM_ADDNOTIFICATION,
                PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
                PUNOTIFY_ACTION_APPMSG, CSAM_UPDATE_EXIT_RADIUS,
            0,
    PU_ENDGROUP,
    PUM_ADDCHILD, PU_TITLE( "Search Options" ),
    PUM_ADDCHILD, PU_HORGROUP,
        PUM_ADDCHILD, PU_CHECKBOX( CS_ALERTEXIT_CB, "Match in Buying Agent  /  " ),
        PUM_ADDCHILD, PU_SET_CHECKBOX( CS_HIGHLIGHTEXIT_CB, "Highlight Matches" ),
    PU_ENDGROUP,
    PUM_ADDCHILD, PU_SPACER,
PU_ENDGROUP,
// ****
...
// **** Disabled Items tab ****
PU_ACTION_OBJDEF, CS_DISABLED_ITEMWATCH_TAB, ( PUU32 )"VerGroup", 0,
    PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_DISABLED_ITEMWATCH_LISTVIEW, ( PUU32 )"ListView",
        PUA_CONTROL_HASKEYBOARDFOCUS, TRUE,
        PUA_LISTVIEW_EDITABLE, FALSE,
        PUA_LISTVIEW_TABLE,
            PU_ACTION_OBJDEF, CS_DISABLED_ITEMWATCH_LIST, ( PUU32 )"List",
                PUA_TABLE_NUMFIELDS, 1, 0,
                PUM_TABLE_SETFIELDTYPE, PUFIELD_TYPE_STRINGCOPY, 0,
        0, 0,
        // Buttons
        PUM_ADDCHILD, PU_HORGROUP,
            PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_ENABLE_BTN, ( PUU32 )"Text", PUA_TEXT_STRING, ( PUU32 )"<< Enable",
                PUA_CONTROL_FRAME, PUFRAME_BUTTON,
                PUA_CONTROL_ISBUTTON, TRUE, 0,
                PUM_ADDNOTIFICATION,
                    PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
                    PUNOTIFY_ACTION_APPMSG, CSAM_ENABLE_ITEM,
                0,
             PUM_ADDCHILD, PU_ACTION_OBJDEF, 0, ( PUU32 )"Text", PUA_TEXT_STRING, ( PUU32 )"Remove",
                PUA_CONTROL_FRAME, PUFRAME_BUTTON,
                PUA_CONTROL_ISBUTTON, TRUE, 0,
                PUM_ADDNOTIFICATION,
                    PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
                    PUNOTIFY_ACTION_DOMETHOD, CS_DISABLED_ITEMWATCH_LISTVIEW, PUM_LISTVIEW_REMOVE,
                0,
            PUM_ADDCHILD, PU_ACTION_OBJDEF, 0, ( PUU32 )"Text", PUA_TEXT_STRING, ( PUU32 )"Remove All",
                PUA_CONTROL_FRAME, PUFRAME_BUTTON,
                PUA_CONTROL_ISBUTTON, TRUE, 0,
                PUM_ADDNOTIFICATION,
                    PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
                    PUNOTIFY_ACTION_APPMSG, CSAM_REMOVE_ALL_DISABLED,
                0,
        PU_ENDGROUP,
        PUM_ADDCHILD, PU_LABEL( "Disabled items are not searched for." ),
        PUM_ADDCHILD, PU_LABEL( "Use Enable to move back to active list." ),
		PUM_ADDCHILD, PU_SPACER,
    PU_ENDGROUP,
// ****
...
// **** Main window ***
    ...
    ( PUU32 )"Window",
    PUA_WINDOW_TITLE, ( PUU32 )"ClickSaver (Skuly Edition)",
    ...
    PUA_WINDOW_CONTENTS,
        PU_ACTION_OBJDEF, CS_TABS, ( PUU32 )"Register",
            ...
            PUM_REGISTER_ADDTAB, ( PUU32 )"Disabled",
            PUM_REGISTER_ADDTAB, ( PUU32 )"Locations",
			PUM_REGISTER_ADDTAB, ( PUU32 )"Exits",
            ...
            PUM_REGISTER_SETTABOBJECT, PU_OBJID, CS_DISABLED_ITEMWATCH_TAB,
            PUM_REGISTER_SETTABOBJECT, PU_OBJID, CS_LOCWATCH_TAB,
			PUM_REGISTER_SETTABOBJECT, PU_OBJID, CS_EXITS_TAB,
...
// **** Buying agent window
    ...
    PUA_WINDOW_XPOS, 300,
    PUA_WINDOW_YPOS, 100,
    PUA_WINDOW_WIDTH, 300, 
    PUA_WINDOW_CONTENTS,
        PU_VERGROUP,
            PUM_ADDCHILD, PU_HORSPACER( 20 ),
            PUM_ADDCHILD, PU_HORGROUP,
                PUM_ADDCHILD, PU_FIXSPACER( 20, 1 ),
                PUM_ADDCHILD, PU_LABEL( "Buying agent is ..." ),
                PUM_ADDCHILD, PU_FIXSPACER( 20, 1 ),
            PU_ENDGROUP,
			PUM_ADDCHILD, PU_HORSPACER(5),
			PUM_ADDCHILD, PU_HORGROUP,
				PUM_ADDCHILD, PU_FIXSPACER(20, 1),
				PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_BA_STATUS, (PUU32)"Text",
					PUA_TEXT_STRING, (PUU32)"Running...",
					PUA_TEXT_CENTERMODE, PU_TEXT_CENTER,
				0, 0,
				PUM_ADDCHILD, PU_FIXSPACER(20, 1),
			PU_ENDGROUP,
            PUM_ADDCHILD, PU_HORSPACER( 10 ),
            PUM_ADDCHILD, PU_HORGROUP,
                PUM_ADDCHILD, PU_FIXSPACER( 20, 1 ),
                PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_BA_PROGRESS, ( PUU32 )"Text",
                    PUA_TEXT_STRING, ( PUU32 )"Current mission: Attempt ? of ?",
                    PUA_TEXT_CENTERMODE, PU_TEXT_CENTER,
                0, 0,
                PUM_ADDCHILD, PU_FIXSPACER( 20, 1 ),
            PU_ENDGROUP,
            ...
            PUM_ADDCHILD, PU_HORGROUP,
                PUM_ADDCHILD, PU_FIXSPACER( 20, 1 ),
                PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_BA_TOTAL, ( PUU32 )"Text",
                    PUA_TEXT_STRING, ( PUU32 )"Total attempts: 0",
                    PUA_TEXT_CENTERMODE, PU_TEXT_CENTER,
                0, 0,
                PUM_ADDCHILD, PU_FIXSPACER( 20, 1 ),
            PU_ENDGROUP,
            ...
            PUM_ADDCHILD, PU_HORGROUP,
                PUM_ADDCHILD, PU_FIXSPACER( 20, 1 ),
                PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_BA_ACCEPTED, ( PUU32 )"Text",
                    PUA_TEXT_STRING, ( PUU32 )"Accepted 0 of 0",
                    PUA_TEXT_CENTERMODE, PU_TEXT_CENTER,
                0, 0,
                PUM_ADDCHILD, PU_FIXSPACER( 20, 1 ),
            PU_ENDGROUP,
            PUM_ADDCHILD, PU_HORSPACER( 10 ),
			PUM_ADDCHILD, PU_ACTION_OBJDEF, CS_BUYINGAGENT_PAUSEBTN, ( PUU32 )"Text",
                PUA_TEXT_STRING, ( PUU32 )"Pause",
                PUA_CONTROL_FRAME, PUFRAME_BUTTON,
                PUA_CONTROL_ISBUTTON, TRUE, 0,
                PUM_ADDNOTIFICATION,
                    PUNOTIFY_CONDITION_ATTREQUALS, PUA_CONTROL_CLICKED, TRUE,
                    PUNOTIFY_ACTION_APPMSG, CSAM_PAUSEBUYINGAGENT,
                0,
            PUM_ADDCHILD, PU_ACTION_OBJDEF, 0, ( PUU32 )"Text",
                PUA_TEXT_STRING, ( PUU32 )"Close",
                PUA_CONTROL_FRAME, PUFRAME_BUTTON,
                PUA_CONTROL_HASKEYBOARDFOCUS, TRUE,
                PUA_CONTROL_ISBUTTON, TRUE, 0,
                PUM_ADDNOTIFICATION,
